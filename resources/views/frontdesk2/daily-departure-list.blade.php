...
<div class="main-content">
        ...
        <a type="button" class="btn btn-white active" href="{{route('frontdesk.dailyDepartureList')}}"><i class="fa fa-list"></i>Daily Departure List</a>
          ...
          <div class="header">
            <h2><strong>DAILY DEPARTURE LIST</strong></h2>
          </div>
