                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <br>
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-9">
                           <div class="icheck-inline">     
                               <label class="f-11"><input type="radio" name="chargeType" id="chargeType" data-radio="iradio_minimal-blue" value="1"> Cash</label>
                                  <label class="f-11"><input type="radio" name="chargeType" id="chargeType" checked data-radio="iradio_minimal-blue" value="2"> Credit Card</label>
                                </div>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                           <div class="icheck-inline">
                                  <label class="f-11"><input type="radio" name="guaranteed" data-radio="iradio_minimal-blue" value="1"> Yes</label>
                                  <label class="f-11"><input type="radio" name="guaranteed" checked data-radio="iradio_minimal-blue" value="2"> No</label>
                                </div>
                          </div>
                        </div>
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group">
                                        <div class="icheck-inline">
                                          @foreach($rooms as $r)
                                            @if($r->type == 11)
                                        <label class="f-10 label-checkbox" id="{{$r->id}}">
