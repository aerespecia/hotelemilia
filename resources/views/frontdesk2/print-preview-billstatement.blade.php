            ...
            <div style="padding-left:10px;padding-right:10px;padding-top:10px;">
                <table style="margin-bottom:10px;width:100%;table-layout:fixed;">
                        <tr style="margin-bottom:10px;">
                            ...
                            <td valign="top">
                              <p class="f-10">{{date('m/d/Y',strtotime($transDetails->arrivalDate))}}</p>
                            </td>
                        </tr>
                        <tr style="margin-top:10px;">
                            ...
                            <td valign="top">
                              <p class="f-10">{{$transDetails->code}}</p>
                            </td>
                            <td valign="top">
                              <p class="f-10">Departure Date: </p>
                            </td>
                            <td valign="top">
                              <p class="f-10">{{date('m/d/Y',strtotime($transDetails->depatureDate))}}</p>
                            </td>
                        </tr>
                        <tr style="margin-top:10px;">
                            <td valign="top">
