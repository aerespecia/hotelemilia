...
<html lang="en">
  <head>
    ...
    <link href="{{url('assets/imported/DataTables-1.10.13/media/css/jquery.dataTables.min.css')}}" rel="stylesheet">
    

    <link href="{{url('assets/imported/DataTables-1.10.13/extensions/Buttons/css/buttons.dataTables.min.css')}}" rel="stylesheet">
...
setInterval(GetClock,1000);
  ...
  <!-- BEGIN BODY -->
  <body class="fixed-sidebar theme-sdtl color-primary">
    <!--[if lt IE 7]>
...
<div class="sidebar border-right">
        ...
        <div class="sidebar-inner">
          ...
          <ul class="nav nav-sidebar">
            <li class="nav-active active"><a href="{{route('admin.index')}}"><i class="icon-home"></i><span>Dashboard</span></a></li>
            <li class="nav-parent">
              <a href="#"><i class="icon-user"></i><span>Profiling</span> <span class="fa arrow"></span></a>
              <ul class="children collapse">
                <li><a href="{{route('admin.guest')}}"> Guests</a></li>
                <li><a href="{{route('admin.booking')}}"> Booking Persons</a></li>
                <li><a href="{{route('admin.institution')}}"> Institutions</a></li>
              </ul>
            </li>
            <li class="nav-parent">
              <a href=""><i class="icon-bar-chart"></i><span>Sales </span><span class="fa arrow"></span></a>
              <ul class="children collapse">
                <li><a href="{{route('admin.shiftCashReport')}}"> Shifts Cash Report</a></li>  
                <li><a href="{{route('admin.periodSalesReport')}}"> Periodly Close Sales Report</a></li>
                <li><a href="{{route('admin.transactionsAnalysis')}}"> Transactions Analysis</a></li>
                <li><a href="{{route('admin.fnb')}}"> FNB & Others</a></li>
              </ul>
            </li>
            <li class="nav-parent">
              <a href=""><i class="icon-layers"></i><span>Reservations</span><span class="fa arrow"></span></a>
              <ul class="children collapse">
                <li><a href="{{route('admin.transactions')}}"> Trasanctions </a></li>
                <li><a href="{{route('admin.checkInReservation')}}"> Checked-in </a></li>
                <li><a href="{{route('admin.guaranteedReservation')}}"> Guaranteed </a></li>
                <li><a href="{{route('admin.activeReservation')}}"> Active </a></li>
                <li><a href="{{route('admin.archiveReservation')}}"> Archive </a></li>
              </ul>
            </li>
            <li class="nav-parent">
              <a href=""><i class="icon-note"></i><span>Room Management </span><span class="fa arrow"></span></a>
              <ul class="children collapse">
                <li><a href="{{route('admin.discount')}}">Discounts Details</a></li>
                <li><a href="{{route('admin.roomstatus')}}"> Room Details</a></li>
                <li><a href="{{route('admin.roomManage')}}"> Room Management</a></li>
                <li><a href="{{route('admin.roomPricing')}}"> Room Pricing</a></li>
                <li><a href="{{route('admin.roomIssue')}}"> Room Casualties</a></li>
                <li><a href="{{route('admin.roomCheckList')}}"> Room Check List Items</a></li>
                <li><a href="{{route('admin.roomReplenishReport')}}"> Room Issues Items</a></li>
              </ul>
            </li>   
            ...
            <li class="nav-parent">
              ...
              <ul class="children collapse">
                ...
                <li><a href="{{route('admin.shifts')}}"> Manage Shifts</a></li>
                <li><a href="{{route('admin.roomHistory')}}"> View Housekeeping History</a></li>
