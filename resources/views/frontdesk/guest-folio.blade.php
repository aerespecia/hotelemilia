        ...
        columns: [
            ...
            "render": function(data, type, full, meta){
                  var valueHere=data.id;
                   return '<button type="button" data-id="1" data-toggle="modal" data-target="#modal-room-register" class="btn btn-sm btn-default edit-modal" id="edit-modal" onlick="buttonAppear()" value="'+valueHere+'">Manage</button><button type="button" data-id="2" value="'+valueHere+'" class="btn btn-sm btn-danger">Remove</button>';
            }
        }
        ]
    });
