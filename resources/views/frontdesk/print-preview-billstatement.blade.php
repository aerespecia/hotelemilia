            ...
            <div style="padding-left:10px;padding-right:10px;padding-top:10px;">
                <table style="margin-bottom:10px;width:100%;table-layout:fixed;">
                        ...
                        <tr style="margin-bottom:10px;">
                            ...
                            <td valign="top">
                              <p class="f-10" style="font-weight:bold;">{{date('m/d/Y',strtotime($arrivalDate))}}</p>
                            </td>
                        </tr>
                        <tr style="margin-top:10px;">
                            ...
                            <td valign="top">
                              <p class="f-10" style="font-weight:bold;">{{date('m/d/Y',strtotime($departureDate))}}</p>
                            </td>
                        </tr>
                        <tr style="margin-top:10px;">
                            <td valign="top">
                            ...
                            <td valign="top">
                              <p class="f-10">Status:</p> 
                            </td>
                            <td valign="top">
                              <p class="f-10">{{$transDetails->transStatus}}</p>
                            </td>
                        </tr>
                                ...
                                <thead>
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                        <td valign="top" style="border-bottom: 1px solid #ddd;padding: 8px;">
                                            {{date('m/d/Y',strtotime($a->amendArriv))}}
                                        </td>
                                   ...
                                   <tr>
                                    ...
                                    <?php $balance = ($amountTotal+$shuttleServiceTotal) - ($paymentTotal+$discountsTotal+$transDetails->withHoldingTax); 
                                  ...
                                  <!--   <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td valign="top" style="padding: 4px;text-align:right;font-style:italic;">({{number_format($transDetails->withHoldingTax,2)}})</td>
                                    </tr>
                                       <tr>
                                        <td></td>
                                        <td></td>
                                        ...
                                        <td valign="top" class="f-13" style="padding: 4px;text-align:right;font-weight:bold;"> &#8369; {{number_format(($amountTotal+$shuttleServiceTotal)-$discountsTotal-$transDetails->withHoldingTax,2)}}</td></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td colspan="2" style="text-align:right;padding: 5px;"></td>
                  ...
                  <div style="border-width:1px;border-color:#b6b6b6;border-style:dashed;border-radius:6px;margin-right:5px;padding:6px;">
                    <table style="width:100%;table-layout:fixed;text-align:left;margin-bottom:10px;">
                        ...
                        <tr style="margin-bottom:10px;">
                            ...
                            <td valign="top">
                              <p id="subtotalInput" class="f-10" style="font-style:italic;text-align:right;"> {{number_format($amountTotal-(($amountTotal/1.19)*0.12)-(($amountTotal/1.19)*0.07),2)}}
                              </p>
                            </td>
                        ...
                        <tr style="margin-top:10px;">
                            ...
                            <td valign="top">
                              <p class="f-10" id="vatInput" style="text-align:right;font-style: italic;font-weight:bold;"> {{number_format(($amountTotal/1.19)*0.12,2)}}</p>
                            </td>
                        ...
                        <tr style="margin-top:10px;">
                            ...
                            <td valign="top">
                              <p class="f-10" id="scInput" style="text-align:right;font-style: italic;font-weight:bold;">
...
<br/><br/><br/><br/>
         <div id="header-1" align="right" style="border-bottom:1px solid dashed;border-color:#b6b6b6;">
                    ...
                    {!! Form::open(['method'=>'POST','action'=>'FrontDeskController@closeTransaction']) !!}
                        ...
                        <input type="submit" style="cursor:pointer;padding:10px;margin-right:5px;float:right;" onclick="return confirm('This will close the transaction and will be marked as Partial Payment. Make sure all payments are settled/arranged. Are you sure you want to continue?')" value="Send Bill"/>
                    {!! Form::close() !!}
              ...
              <tr>
                <td>
                   <label>VAT</label>
                  <input type="text" id="vatNew" onkeydown="changeVATSC();" onkeyup="changeVATSC();" size="10" class="field-divided"/>&nbsp;&nbsp;
                </td>
                <td>
                  <label>SC</label>
                  <input type="text" id="scNEW" onkeydown="changeVATSC();" onkeyup="changeVATSC();" class="field-divided"/>
                </td>
              </tr>
            </table>
         ...
         <div id="header-1" style="text-align:right;" class="form-style-1">
 ...
 function addCommas(nStr)
{
 ...
 function changeVATSC(){

  var vat = document.getElementById('vatNew').value;
  var sc = document.getElementById('scNEW').value;

  document.getElementById('subtotalInput').innerHTML = addCommas(amountTotal -sc - vat);

  document.getElementById('vatInput').innerHTML = addCommas(vat);
  document.getElementById('scInput').innerHTML = addCommas(sc);
