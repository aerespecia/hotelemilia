...
<div class="main-content m-t-0 p-t-0">
        ...
        <div class="page-content page-thin">
          ...
          <div class="header">
            <h2><strong>Room Issues</strong></h2>
          </div>
...
$(function() {
    $('#users-table').DataTable({
                ...
                serverSide: false,
                "bDestroy": true,
                ajax: "{{route('admin.dataTablesRoomIssues')}}",
                lengthMenu: [
                    [ 5, 10, 25, 50, -1 ],
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label class="control-label f-12">Type</label>
                                <input type="text" name="type" id="type" class="form-control" placeholder="Contact No..." minlength="3">
                            </div>
                          </div>
