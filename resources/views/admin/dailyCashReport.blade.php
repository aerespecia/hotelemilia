...
<tr>
	...
	<th>{{number_format(((($t->totalBill + $t->serviceCharge + $t->shuttleService) - $t->totalChargeDiscount)-$t->downpaymentsTotal),2)}}</th>
...
<tr>
	<th colspan="15" style="text-align:right">TOTAL NET INCOME: </th>
	<th colspan="3" style="text-align:right">{{number_format($netIncome,2)}}</th>
</tr>
<tr>
	<th colspan="15" style="text-align:right">CASH ON HAND: </th>
	<th colspan="3" style="text-align:right">{{number_format($downpaymentsOverallTotal,2)}}</th>
</tr>
<tr>
	<th colspan="15" style="text-align:right">ACCOUNT RECEIVABLES: </th>
