...
<div class="main-content">
        ...
        <div class="page-content p-l-40 p-r-40 p-t-10">
            <div class="btn-group">
              <a class="btn btn-white active" href="{{route('frontdesk.dailyGuestArrival')}}"><i class="fa fa-plus"></i>Daily Arrival List</a>
        ...
        <a type="button" class="btn btn-white" href="{{route('frontdesk.dailyDepartureList')}}"><i class="fa fa-list"></i>Daily Departure List</a>
          ...
          <div class="header">
            <h2><strong>DAILY ARRIVAL LIST</strong></h2>
          </div>
...
$(function() {
    $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('frontdesk.dataTablesDailyArrivalList') !!}',
        columns: [
            { data: 'id', name: 'id' },
            ...
            { data: 'depatureDate' , name: 'arrivalDate' },
        ]
    });
});
</script>
