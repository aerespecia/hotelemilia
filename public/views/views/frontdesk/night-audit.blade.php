        ...
        <div class="page-content p-l-40 p-r-40 p-t-10">
          ...
          <div class="header">
           ...
           <div class="panel">
               ...
               <h4>ROOM RESERVATIONS/CHARGES</h4>
               <h6>Date: September 20, 2016</h6> 
               </div>
             ...
             <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <td>201</td>
                        <td>Hospitality</td>
                        <td>Melvin Cruz, Christian Jeremy</td>
                        <td>2</td>
                        <td>&#8369; 1,500</td>
                        <td>September 19-21, 2016</td>
                        <td>&#8369; 2,000 <button type="button" class="btn-sm btn-default btn-transparent">View Details</button></td>
                        <td>Cash</td>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <h5 class="col-md-10">Occupied: <strong>37</strong></h5>
                                    </div>
                                    <div class="row">
                                        <h5 class="col-md-10">Vacant: <strong>37</strong></h5>
                                    </div>
                                    <div class="row">
                                        <h5 class="col-md-10">House Use: <strong>37</strong></h5>
                                    </div>
                                    <div class="row">
                                        <h5 class="col-md-10">Out of Order: <strong>37</strong></h5>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                 
                                    <div class="row">
                                        <h5 class="col-md-10">Arrival: <strong>37</strong></h5>
                                    </div>
                                    <div class="row">
                                        <h5 class="col-md-10">Check out: <strong>37</strong></h5>
                                    </div>
                                    <div class="row">
                                        <h5 class="col-md-10">Occupancy %: <strong>75%</strong></h5>
                                    </div>
